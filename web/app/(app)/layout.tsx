  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-white dark:bg-zinc-950">
      ...
      <div className="mx-auto flex w-full min-h-0 max-w-7xl flex-1 gap-0 px-4 lg:px-8">
        <main className="min-h-0 min-w-0 flex-1 overflow-y-auto pb-6 pt-2 max-sm:pb-[calc(4.5rem+env(safe-area-inset-bottom))] max-sm:pt-[calc(0.5rem+env(safe-area-inset-top))]">
          {children}
        </main>
