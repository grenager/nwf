      ...
      <StandardsProvider>
        <div className="flex min-h-dvh flex-col bg-white lg:h-screen lg:overflow-hidden dark:bg-zinc-950">
          ...
          <div className="mx-auto flex w-full min-h-0 max-w-7xl flex-1 gap-0 px-4 max-sm:px-0 lg:px-8">
            <main className="min-h-0 min-w-0 flex-1 pb-6 pt-2 max-sm:px-3 max-sm:pb-[calc(4.5rem+env(safe-area-inset-bottom)+var(--tabbar-inset))] max-sm:pt-[calc(0.5rem+var(--top-inset))] lg:overflow-x-hidden lg:overflow-y-auto">
              {children}
            </main>
